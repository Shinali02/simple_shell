...
/**
 * add_node - Addition of a node to the start of a list
 ...
 * @head: A pointe ddress to the head node.
...
/**
 * print_list_str - Prints only the str elements of a list_t linked list.
 ...
 *
 * Return: Always 1(Success), 0 on error.
 */
